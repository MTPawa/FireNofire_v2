...
def train_model(args: argparse.Namespace) -> None:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # Evaluate both test sets every epoch, so the full training process is logged.
    ...
    final_results = {
        ...
        "best_val_accuracy": best_val_acc,
        "final_evaluation_using_best_model": final_eval,
        "class_to_idx": class_to_idx,
        "idx_to_class": idx_to_class,
        "run_dir": str(run_dir),
        "best_model_path": str(checkpoints_dir / "best_model.pth"),
...
def plot_training_curves(history: Dict[str, Any], plots_dir: Path) -> None:
    """Save training plots: loss, accuracy, LR."""
